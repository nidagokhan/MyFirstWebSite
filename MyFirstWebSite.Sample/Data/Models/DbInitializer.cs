...
namespace MyFirstWebSite.Sample.Models
{
                ...
                if (!context.Drinks.Any())
                {
                    ...
                    (
                        ...
                        InStock = 145,
                            ...
                            ImageThumbnailPath = "http://imgh.us/beerS_1.jpeg"
                        },
                        new Drink
                        {
                            Name = "Rum & Coke",
                        ...
                        InStock = 54,
                            ...
                            ImageThumbnailPath = "http://imgh.us/rumAndCokeS.jpg"
                        },
                        new Drink
                        {
                            Name = "Tequila ",
                        ...
                        InStock = 345,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/tequilaS.jpg"
                        },
                        new Drink
                        {
                            Name = "Wine ",
                        ...
                        InStock = 234,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/wineS.jpg"
                        },
                        new Drink
                        {
                            Name = "Margarita",
                        ...
                        InStock = 543,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/margaritaS.jpg"
                        },
                        new Drink
                        {
                        ...
                        InStock = 123,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/whiskeyS.jpg"
                        },
                        new Drink
                        {
                            Name = "Jägermeister",
                            ...
                            LongDescription = "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of de Finibus Bonorum et Malorum (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from de Finibus Bonorum et Malorum by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.",
                            Category = Categories["Alcoholic"],
                        // ImagePath = "http://imgh.us/jagermeisterL.jpg",
                        InStock = 876,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/jagermeisterS.jpg"
                        },
                        new Drink
                        {
                            Name = "Champagne",
                        ...
                        InStock = 543,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/champagneS.jpg"
                        },
                        new Drink
                        {
                            Name = "Piña colada ",
                            ...
                            LongDescription = "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of de Finibus Bonorum et Malorum (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from de Finibus Bonorum et Malorum by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.",
                            Category = Categories["Alcoholic"],
                        // ImagePath = "http://imgh.us/pinaColadaL.jpg",
                        InStock = 345,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/pinaColadaS.jpg"
                        },
                        new Drink
                        {
                            Name = "White Russian",
                        ...
                        InStock = 65,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/whiteRussianS.jpg"
                        },
                        new Drink
                        {
                            ...
                            LongDescription = "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of de Finibus Bonorum et Malorum (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from de Finibus Bonorum et Malorum by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.",
                            Category = Categories["Alcoholic"],
                        // ImagePath = "http://imgh.us/longTeaL.jpg",
                        InStock = 134,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/islandTeaS.jpg"
                        },
                        new Drink
                        {
                            Name = "Vodka",
                        ...
                        InStock = 0,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/vodkaS.jpg"
                        },
                        new Drink
                        {
                            Name = "Gin and tonic",
                        ...
                        InStock = 0,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/ginTonicS.jpg"
                        },
                        new Drink
                        {
                            Name = "Cosmopolitan",
                        ...
                        InStock = 0,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/cosmopolitanS.jpg"
                        },
                        new Drink
                        {
                            Name = "Tea ",
                        ...
                        InStock = 575,
                            IsPreferredDrink = true,
                            ImageThumbnailPath = "http://imgh.us/teaS.jpg"
                        },
                        new Drink
                        {
                            Name = "Water ",
                        ...
                        InStock = 57,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/waterS_1.jpg"
                        },
                        new Drink
                        {
                            Name = "Coffee ",
                        ...
                        InStock = 474,
                            IsPreferredDrink = true,
                            ImageThumbnailPath = "http://imgh.us/coffeS.jpg"
                        },
                        new Drink
                        {
                            Name = "Kvass",
                        ...
                        InStock = 474,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/kvassS.jpg"
                        },
                        new Drink
                        {
                            Name = "Juice ",
                        ...
                        InStock = 478,
                            IsPreferredDrink = false,
                            ImageThumbnailPath = "http://imgh.us/juiceS.jpg"
                        }
                    );
                }
